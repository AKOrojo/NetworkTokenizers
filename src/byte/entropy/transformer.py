...
from src.byte.entropy.base_transformer import (
    BaseTransformer,
    BaseTransformerArgs,
    cross_entropy,
)
from src.byte.entropy.utils import create_causal_mask
...
def _serialize_lm_args(args_instance: LMTransformerArgs) -> dict:
    """Converts LMTransformerArgs object to a serializable dictionary."""
    return {"args": args_instance.model_dump()}

def _deserialize_lm_args(data: dict) -> LMTransformerArgs:
    """Creates an LMTransformerArgs object from a dictionary."""
    return LMTransformerArgs(**data["args"])
